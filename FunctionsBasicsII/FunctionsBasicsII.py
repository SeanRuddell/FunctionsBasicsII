...
def print_return(inputlist):
    print(inputlist[0])
    return(inputlist[1])
print(print_return([6,9]))
...
print(first_plus_length([97, 72, 14, 9, 96]))
...
def values_greater_than_second(list):
    ...
    print(len(newlist))
    return newlist
print(values_greater_than_second([9, 3, 1, 10, 12, 15]))
...
def length_and_value(a, b):
    ...
    for i in range(a):
        alist.append(b)
    return alist
print("Hi! I'm a piece of wood ", length_and_value(4, 4))
